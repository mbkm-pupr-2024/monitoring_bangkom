    ...
    public function print_SuratUndanganRapatPersiapan($id_pl, $id_kthp, Request $request)
{
    ...
    public function print_SuratPenetapanPengajar($id_pelatihan, Request $request)
    {
        $request->validate([
    ...
    public function print_SuratPenetapanPeserta($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
    ...
    public function print_FormBiodataTF4($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
    ...
    public function print_SambutanPembukaanKepalaPusat($id_pl, $id_kthp, Request $request)
    {
        $pelatihan = PelatihanModel::find($id_pl);
    ...
    public function print_VirtualBackgroundSpandukBackdrop($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
    ...
    public function print_DokumentasiCeremonyPembukaan($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
    ...
    public function print_BahanTayangPengajar($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
    ...
    public function print_LaporandanBahanTayangSeminarPeserta($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
    ...
    public function print_BiodataPengajar($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
    ...
    public function print_AbsensiPeserta($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
    ...
    public function print_AbsensiPengajar($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
    ...
    public function print_FormPenilaianSikapPerilaku($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
    ...
    public function print_SuratUndanganRapat($id_pl, $id_kthp, Request $request)
    {
        $pelatihan = PelatihanModel::find($id_pl);
    ...
    public function print_DokumentasiCeremonyPenutupan($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
    ...
    public function print_SuratPengembalianPeserta($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_peserta' => 'required|mimes:xls,xlsx',
        ]);
        ...
        return view('dokumen.pengembalian_peserta', compact('data'), [
            'pelatihan' => $pelatihan, 'id_pelatihan' => $id_pelatihan, 'request' => $request,
        ]);

    }
    public function print_SPMK($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
    ...
    public function print_LaporanAkhirPelatihan($id_pelatihan, Request $request)
    {
        $request->validate([
            'daftar_calon_peserta' => 'required|mimes:xls,xlsx',
        ]);
