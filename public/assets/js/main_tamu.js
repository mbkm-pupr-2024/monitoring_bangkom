$(document).ready(function () {
    ...
    const appMenu = function () {
        ...
        if ($('.horizontal-menu').length) {
            ...
            var select_sub_menus = $('.app-menu-tamu li:not(.open) ul'),
            active_page_sub_menu_link = $('.app-menu-tamu li.active-page > a');
            ...
            if ($(window).width() > 1199) {
                ...
                var container = document.querySelector('.app-menu-tamu');
            ...
            $('.app-menu-tamu li a').on('click', function (e) {


                var sub_menu = $(this).next('ul'),
                    parent_list_el = $(this).parent('li'),
                    active_list_element = $('.app-menu-tamu .menu-list > li.open'),
        ...
        function toggleSidebar() {
            ...
            if ($('.app').hasClass('sidebar-hidden')) {
                setTimeout(function () {
                    $('.app-sidebar-tamu .logo-tamu').addClass('hidden-sidebar-logo');
                }, 200)
                if ($(window).width() > 1199) {
                    $('.hide-sidebar-toggle-button i').text('last_page');
                } else {
                ...
                $('.app-sidebar-tamu .logo-tamu').removeClass('hidden-sidebar-logo');
        ...
        $('.menu-off-canvas .hide-sidebar-toggle-button').on('click', function () {
            ...
            if ($('.app').hasClass('menu-off-canvas-show')) {
                    $('.app-sidebar-tamu .logo-tamu').addClass('canvas-sidebar-hidden-logo');
            } else {
                setTimeout(function () {
                    $('.app-sidebar-tamu .logo-tamu').removeClass('canvas-sidebar-hidden-logo');
                }, 200)
            }
            return false;
        });
