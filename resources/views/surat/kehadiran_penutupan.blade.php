...
<head>
  ...
  <link
    ...
    rel="stylesheet">
  <title>Surat Permohonan Menghadiri Penutupan</title>
</head>
...
<body>
  <div class="container">
      ...
      <div class="judul">
        <table>
            ...
            <tr>
                <td>Hal</td>
                <td>:</td>
                <td style="word-wrap: break-word;vertical-align:middle">Permohonan Menghadiri Penutupan Pelatihan {{ $pelatihan->nama }}</td>
            </tr>
        </table>
      </div>
      <div class="isi-surat">
        <p>Yth. <b>Sekretaris Direktorat Jenderal Bina Konstruksi</b> <br>di Jakarta</p>

        <p style="text-indent: 50px; line-height: 1.5;">Disampaikan dengan hormat bahwa Balai Pengembangan Kompetensi PUPR Wilayah VI Surabaya sedang menyelenggarakan Pelatihan {{ $pelatihan->nama }} pada tanggal 29 Januari s.d. 06 Februari 2024 secara Blended Learning. Sehubungan dengan hal tersebut, kami memohon perkenan Ibu untuk menghadiri penutupan pelatihan dimaksud pada:</p>
        <table style="text-indent: 10px;line-height: 1.5;">
          <tr>
            <td width="200px" >Hari/tanggal</td>
            <td>:</td>
            <td>Selasa / 06 Januari 2024 </td>
          </tr>
          <tr>
            <td>Waktu</td>
            <td>:</td>
          ...
          <tr>
            ...
            <td>:</td>
            <td>
                <i>Zoom Meeting Id Meeting</i> : <b>925 7842 3144</b> <i>Passcode</i> : <b>123456</b>
            </td>
          </tr>
        </table>
    ...
    <p><b>Tembusan:</b></p>
    <ol>
        <li>Sekretaris Badan Pengembangan Sumber Daya Manusia Kementerian PUPR;</li>
