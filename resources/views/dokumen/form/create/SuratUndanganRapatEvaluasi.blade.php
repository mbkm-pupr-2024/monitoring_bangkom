                            ...
                            <div class="widget-stats-container">
                                <form action="{{ route('create-'. $nama_fungsi, ['id_pl' => $pelatihan->id, 'id_kthp' => $kegiatan->id]) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="surat_edaran" name="surat_edaran">
                                    </div>
                                    <div class="row">
                                        <div class="col-3">
                                            <label for="nomor_surat_edaran" class="form-label">Nomor Surat Edaran</label>
                                            <input type="text" class="form-control" id="nomor_surat_edaran" name="nomor_surat_edaran">
                                        </div>
                                        <div class="col-9">
                                            <label for="hal_surat_perintah" class="form-label">Hal Surat Edaran</label>
