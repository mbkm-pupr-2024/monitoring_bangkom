                            ...
                            <div class="widget-stats-container">
                                <form action="{{ route('create-'. $nama_fungsi, ['id_pl' => $pelatihan->id, 'id_kthp' => $kegiatan->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="file" class="form-control @error('req_suratUndanganMenghadiriPenutupan') is-invalid @enderror" id="req_suratUndanganMenghadiriPenutupan" name="req_suratUndanganMenghadiriPenutupan" accept=".xls, .xlsx" value="{{ old('req_suratUndanganMenghadiriPenutupan') }}">
                                        <div class="invalid-feedback">
                                            @error('req_suratUndanganMenghadiriPenutupan')
                                                Requirement harus diisi
                                            @enderror
                                        </div>
                                    </div>
                                    <p>Download requirement berikut untuk mengisi requirement diatas: 
                                        <a href="{{ route('download-requirement', ['file' => 'req_suratUndanganMenghadiriPenutup']) }}">Unduh requirement</a>
                                    </p>
                                    <br>
                                    <div class="mb-4">
