                            ...
                            <div class="widget-stats-container">
                                <form action="{{ route('upload-'. $nama_fungsi, ['id_pl' => $pelatihan->id, 'id_kthp' => $kegiatan->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="file" class="form-control @error('notulenRapatPersiapan') is-invalid @enderror" id="notulenRapatPersiapan" name="notulenRapatPersiapan" accept=".pdf, .docx" value="{{ old('notulenRapatPersiapan') }}">
                                        <div class="invalid-feedback">
                                            @error('notulenRapatPersiapan')
                                                Dokumen harus diisi
                                            @enderror
                                        </div>
                                    </div>
