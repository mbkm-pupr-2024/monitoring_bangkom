                    ...
                    <div class="card widget">
                        <div class="card card-body">
                            <div class="widget-stats-container">
                                <form action="/pelatihan-tambah" method="POST">
                                    @csrf
                                    <div class="mb-4">
                                        <label for="nama_pelatihan" class="form-label">Nama Pelatihan</label>
                                        <input type="text" class="form-control" id="nama_pelatihan" name="pelatihan">
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <select class="js-states form-control" id="bidang_pelatihan" tabindex="-1" style="display:none;width: 100%" name="bidang_pelatihan">
                                            ...
                                            @foreach ($bidangPelatihan as $bidang)
                                                <option value={{ $bidang->id }}>{{ $bidang->bidang_pelatihan }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="mb-4">
